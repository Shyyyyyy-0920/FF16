                ...
                if self.flag == 0:
                    if self.sign==0:
                        for i in range(4):
                            ...
                            self.sign=1
                    self.damage_player(self.attack_sprites,5)
                ...
                if self.flag == 0:
                    if self.sign==0:
                        for i in range(5):
                            ...
                            self.sign=1
                    self.damage_player(self.attack_sprites,15)
                    for sprite in self.attack_sprites:  # 使用 copy() 避免迭代过程中改变集合大小的问题
                        if self.battle_start_time - sprite.creat_time >= 1500:  # 如果存活时间超过2秒
                            sprite.kill()  # 移除该对象
                    if len(self.attack_sprites) == 0:
                ...
                if self.flag == 1:
                    if self.sign==1:
                        for i in range(10):
                            ...
                            self.attack_sprites.add(self.bullet)
                            self.sign=0
                    self.damage_player(self.attack_sprites,6)
                    for sprite in self.attack_sprites:  # 使用 copy() 避免迭代过程中改变集合大小的问题
                        if self.battle_start_time - sprite.creat_time >= 2500:  # 如果存活时间超过2.5秒
                            sprite.kill()  # 移除该对象
                            self.flag=0
                ...
                if self.flag == 0:
                    if self.sign==0:
                        for i in range(15):
                            ...
                            self.attack_sprites.add(self.bullet)
                            self.sign=1
                    self.damage_player(self.attack_sprites,10)
                    for sprite in self.attack_sprites:  # 使用 copy() 避免迭代过程中改变集合大小的问题
                        if self.battle_start_time - sprite.creat_time >= 2500:  # 如果存活时间超过2.5秒
                            sprite.kill()  # 移除该对象
                    if len(self.attack_sprites) == 0:
                ...
                if self.flag == 1:
                    if self.sign==1:
                        for i in range(15):
                            ...
                            self.attack_sprites.add(self.bullet)
                            self.sign=0
                    self.damage_player(self.attack_sprites,12)
                    for sprite in self.attack_sprites:  # 使用 copy() 避免迭代过程中改变集合大小的问题
                        if self.battle_start_time - sprite.creat_time >= 2500:  # 如果存活时间超过2.5秒
                            sprite.kill()  # 移除该对象
                            self.flag=0
            ...
            if self.state_boll:
                if self.flag == 0:
                    if self.sign==0:
                        ...
                        self.sign=1
                    self.damage_player(self.attack_sprites,50)
                    for sprite in self.attack_sprites:  # 使用 copy() 避免迭代过程中改变集合大小的问题
                        if self.battle_start_time - sprite.creat_time >= 2500:  # 如果存活时间超过秒
                            sprite.kill()  # 移除该对象
                    if len(self.attack_sprites) == 0:
                    ...
                    if self.sign==1:
                        ...
                        for i in range(9):
                            block_bottom4=block((100-35*i,400),[self.all_sprites,self.attack_sprites],3,'right')
                        self.sign=0
                    self.damage_player(self.attack_sprites,49)
                    for sprite in self.attack_sprites:  # 使用 copy() 避免迭代过程中改变集合大小的问题
                        if self.battle_start_time - sprite.creat_time >= 2500:  # 如果存活时间超过秒
                            sprite.kill()  # 移除该对象
                    if len(self.attack_sprites) == 0:
