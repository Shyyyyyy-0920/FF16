...
class ChatBot:
    def __init__(self, person):
        ...
        self.path = r".\使用到的资源\font\DTM-Sans.otf"
    ...
    def start(self):
        ...
        image_main = pygame.image.load(r".\使用到的资源\Frisk.png").convert()
...
#————————————————————————————————————————————正式开始聊天界面，输入框颜色变化“对焦与失焦”—————————————————————————————————— 
                if chat_open:
                    background_image = pygame.image.load(r".\使用到的资源\background1.png").convert()
